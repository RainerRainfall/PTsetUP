...
#Region "Declarations"
    ...
    Private _Font As Font = New Font("Segoe UI", _FontSize, FontStyle.Bold)
    ...
    Protected Overrides Sub OnMouseDown(e As MouseEventArgs)
        ...
        ElseIf MouseXLoc > Width - 84 AndAlso MouseXLoc < Width - 56 AndAlso MouseYLoc < 25 Then
            If _AllowMinimize Then
                ...
                End Select
            End If
        ElseIf e.Button = system.Windows.Forms.MouseButtons.Left And New Rectangle(0, 0, Width - 84, MoveHeight).Contains(e.Location) Then
...
#Region "Draw Control"
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            .DrawLines(New Pen(_TopStripBorderColour), LeftBorderPoints)
            .DrawRectangle(New Pen(_BorderColour, 3), New Rectangle(0, 0, Width, Height))
            .DrawString("Profit", _Font, New SolidBrush(Color.FromArgb(255, 153, 34)), New Point(5, 5))
            .DrawString("Trailer", _Font, New SolidBrush(Color.FromArgb(59, 175, 218)), New Point(49, 5))
            .DrawString("set", _Font, New SolidBrush(Color.FromArgb(255, 153, 34)), New Point(105, 5))
            .DrawString("UP", _Font, New SolidBrush(Color.FromArgb(59, 175, 218)), New Point(128, 5))
            '.DrawString("P", _Font, New SolidBrush(Color.FromArgb(255, 153, 34)), New Point(5, 5))
            '.DrawString("T", _Font, New SolidBrush(Color.FromArgb(59, 175, 218)), New Point(15, 5))
            '.DrawString("set", _Font, New SolidBrush(Color.FromArgb(255, 153, 34)), New Point(25, 5))
            '.DrawString("UP", _Font, New SolidBrush(Color.FromArgb(59, 175, 218)), New Point(49, 5))
        End With
        MyBase.OnPaint(e)
        G.Dispose()
...
#Region "Declarations"
    ...
    Private _CheckedColour As Color = Color.FromArgb(255, 153, 34)
    Private _BorderColour As Color = Color.FromArgb(210, 210, 210)
...
#Region "Draw Control"
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        Dim B As New Bitmap(Width, Height)
        Dim G = Graphics.FromImage(B)
        Dim Base As New Rectangle(5, 5, Height - 10, Height - 10)
        Dim Circle As New Rectangle(7, 7, Height - 14, Height - 14)
        ...
        With G
            ...
            If Checked Then
                Select Case State
                    Case MouseState.Over
                        .FillEllipse(New SolidBrush(_HoverColour), New Rectangle(4, 4, Height - 8, Height - 8))
                End Select
